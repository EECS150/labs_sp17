...
Begin by instantiating the \verb|music_streamer| module in \verb|ml505top.v|. Connect its \verb|tone| output to the \verb|tone_switch_period| input of the \verb|tone_generator|. Connect its \verb|clk| input to the global clock signal. Connect its \verb|rom_address| output to the \verb|GPIO_LED|s by routing the top 8 bits of the address to the LEDs.
