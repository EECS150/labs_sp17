...
Take a look at the \verb|clock_counter| in your \verb|tone_generator| module, by clicking on \verb|piezo_controller| in the module. Plot the signal in your waveform viewer. You will notice it's also a red line. Red lines in ModelSim indicate undefined signals (indicated in Verilog as the letter \verb|x|).
